...
cov.moon <- c(0.1,0.9)
cov.sex<-c(0,1)
cov.comb <- expand.grid(cov.alan, cov.moon,cov.sex)
...
Forage<-cbind(spm$Forage,u$Forage,l$Forage,cov$rad_log_5,cov$sex,cov$fraction)
...
Fsp<-ggplot(Forage, aes(x = alan, y=sp))+
...
Fsp
ggsave("Data_outputs_sex/Fsp.png",width = 15, height = 7, units = "in", dpi = 350)

Raft<-cbind(spm$Raft,u$Raft,l$Raft,cov$rad_log_5,cov$sex,cov$fraction)
...
Rsp<-ggplot(Raft, aes(x = alan, y=sp))+
  geom_ribbon(size = 1, linetype = "blank", aes(ymin=l, ymax=u,col=moon_fraction,fill=sex), alpha=0.15) + 
  geom_line(aes(colour = moon_fraction,linetype=sex), size = 1.3)+
  scale_color_manual(name = "moon phase", labels = c("Full", "New"), values = c(Full, New)) +
  ...
  xlab("log(ALAN)") + theme_bw()
Rsp
ggsave("Data_outputs_sex/Rsp.png",width = 15, height = 7, units = "in", dpi = 350)

Travel<-cbind(spm$Travel,u$Travel,l$Travel,cov$rad_log_5,cov$sex,cov$fraction)
...
Tsp<-ggplot(Travel, aes(x = alan, y=sp))+
  geom_ribbon(size = 1, linetype = "blank", aes(ymin=l, ymax=u,col=moon_fraction,fill=sex), alpha=0.15) + 
  geom_line(aes(colour = moon_fraction,linetype=sex), size = 1.3)+
  scale_color_manual(name = "moon phase", labels = c("Full", "New"), values = c(Full, New)) +
  ...
  xlab("log(ALAN)") + theme_bw()
Tsp
ggsave("Data_outputs_sex/Tsp.png",width = 15, height = 7, units = "in", dpi = 350)
...
#Raft to forage
RtoF<-ggplot(AlltoF, aes(x = alan, y=Raft))+
...
#Travel to forage
TtoF<-ggplot(AlltoF, aes(x = alan, y=Travel))+
  ...
  xlab("log(ALAN)") + theme_bw()
TtoF
ggsave("Data_outputs_sex/TtoF.png",width = 15, height = 7, units = "in", dpi = 350)

#forage to forage
FtoF<-ggplot(AlltoF, aes(x = alan, y=Forage))+
...
#raft to raft
RtoR<-ggplot(AlltoR, aes(x = alan, y=Raft))+
  geom_ribbon(size = 1, linetype = "blank", aes(ymin=l$Raft, ymax=u$Raft,col=moon_fraction,fill=sex), alpha=0.15) + 
  geom_line(aes(colour = moon_fraction,linetype = sex), size = 1.3)+
  scale_color_manual(name = "moon phase", labels = c("Full", "New"), values = c(Full, New)) +
...
#Travel to raft
TtoR<-ggplot(AlltoR, aes(x = alan, y=Travel))+
  geom_ribbon(size = 1, linetype = "blank", aes(ymin=l$Travel, ymax=u$Travel,col=moon_fraction,fill=sex), alpha=0.15) + 
  geom_line(aes(colour = moon_fraction,linetype = sex), size = 1.3)+
  scale_color_manual(name = "moon phase", labels = c("Full", "New"), values = c(Full, New)) +
...
#forage to raft
FtoR<-ggplot(AlltoR, aes(x = alan, y=Forage))+
  geom_ribbon(size = 1, linetype = "blank", aes(ymin=l$Forage, ymax=u$Forage,col=moon_fraction,fill=sex), alpha=0.15) + 
  geom_line(aes(colour = moon_fraction,linetype = sex), size = 1.3)+
  scale_color_manual(name = "moon phase", labels = c("Full", "New"), values = c(Full, New)) +
...
#raft to travel
RtoT<-ggplot(AlltoT, aes(x = alan, y=Raft))+
  geom_ribbon(size = 1, linetype = "blank", aes(ymin=l$Raft, ymax=u$Raft,col=moon_fraction,fill=sex), alpha=0.15) + 
  geom_line(aes(colour = moon_fraction,linetype = sex), size = 1.3)+
  scale_color_manual(name = "moon phase", labels = c("Full", "New"), values = c(Full, New)) +
...
#Travel to travel
TtoT<-ggplot(AlltoR, aes(x = alan, y=Travel))+
  geom_ribbon(size = 1, linetype = "blank", aes(ymin=l$Travel, ymax=u$Travel,col=moon_fraction,fill=sex), alpha=0.15) + 
  geom_line(aes(colour = moon_fraction,linetype = sex), size = 1.3)+
  scale_color_manual(name = "moon phase", labels = c("Full", "New"), values = c(Full, New)) +
...
#forage to travel
FtoT<-ggplot(AlltoR, aes(x = alan, y=Forage))+
  geom_ribbon(size = 1, linetype = "blank", aes(ymin=l$Forage, ymax=u$Forage,col=moon_fraction,fill=sex), alpha=0.15) + 
  geom_line(aes(colour = moon_fraction,linetype = sex), size = 1.3)+
  scale_color_manual(name = "moon phase", labels = c("Full", "New"), values = c(Full, New)) +
