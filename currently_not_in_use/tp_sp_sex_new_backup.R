...
Fsp<-ggplot(Forage, aes(x = alan, y=sp))+facet_wrap(~sex) + 
  geom_ribbon(size = 1, linetype = "blank", aes(ymin=l, ymax=u,col=moon_fraction), alpha=0.15) + 
  geom_line(aes(colour = moon_fraction), size = 1.3)+
...
Rsp<-ggplot(Raft, aes(x = alan, y=sp))+facet_wrap(~sex) + 
  geom_ribbon(size = 1, linetype = "blank", aes(ymin=l, ymax=u,col=moon_fraction), alpha=0.15) + 
  geom_line(aes(colour = moon_fraction), size = 1.3)+
  scale_color_manual(name = "Moon Phase", labels = c("Full", "New"), values = c(Full, New)) +
...
Tsp<-ggplot(Travel, aes(x = alan, y=sp))+facet_wrap(~sex) + 
  geom_ribbon(size = 1, linetype = "blank", aes(ymin=l, ymax=u,col=moon_fraction), alpha=0.15) + 
  geom_line(aes(colour = moon_fraction), size = 1.3)+
  scale_color_manual(name = "Moon Phase", labels = c("Full", "New"), values = c(Full, New)) +
